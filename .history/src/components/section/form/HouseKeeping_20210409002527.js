...
import ItemList from '../checkListTable'
                ...
                <Row>
                    ...
                    <Tab.Content>
                        <Tab.Panel eventKey="Serviette">
                            <CheckListTable item="towel" />
                        </Tab.Panel>
                        <Tab.Panel eventKey="Savon"> 
                            <CheckListTable item="soap" />
                        </Tab.Panel>
                        <Tab.Panel eventKey="Papier Toilette"> 
                            <CheckListTable item="toilet-paper" />
                        </Tab.Panel>
                        <Tab.Panel eventKey="Sèche-cheveux">
 
                            <CheckListTable item="hair-dryer" />
                        </Tab.Panel>
                        <Tab.Panel eventKey="Coussin"> 
                            <CheckListTable item="pillow" />
                        </Tab.Panel>
                        <Tab.Panel eventKey="Couverture"> 
                            <CheckListTable item="blanket" />
                        </Tab.Panel>
                        <Tab.Panel eventKey="Fer à repasser">
 
                            <CheckListTable item="iron" />
                        </Tab.Panel>
                        <Tab.Panel eventKey="Lit Bébé"> 
                            <CheckListTable item="baby-bed" />
                        </Tab.Panel>
                    </Tab.Content>
                    </Col>
                </Row>
