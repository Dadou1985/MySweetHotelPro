            ...
            <Modal show={list}
                    ...
                    <Modal.Footer>
                        {footerState && <>
                            ...
                            <Button variant="outline-primary" onClick={handleReset} style={{width: "6vw"}}>Reset</Button>
                        </>}
                        {!footerState && <Button variant="outline-info" style={{width: "6vw"}} onClick={handlePrint}>Imprimer</Button>}
                    </Modal.Footer>
                    </form>
                </Modal>
        </div>
