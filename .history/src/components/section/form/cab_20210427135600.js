                            ...
                            <Tab eventKey="Réserver" title="Réserver un taxi">
                                <div  style={{
                                    ...
                                    <Form.Row>
                                        ...
                                        <Form.Control type="text" placeholder="ex: 16 avenue Paul Cézanne, 78990 " style={{width: "23vw"}} value={formValue.destination} name="destination" onChange={handleChange} />
                                        </Form.Group>
                                    </Form.Row>
                                </div>
                            </Tab>
