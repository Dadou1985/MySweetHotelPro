...
const Cab = ({userDB, user}) =>{
    ...
    const [formValue, setFormValue] = useState({room: "", client: "", date: dateFns.date(), hour: dateFns.date(), passenger:"", model:"", destination: ""})
    ...
    const handleSubmit = event => {
        ...
        return db.collection('mySweetHotel')
            ...
            date: dateFns.format(formValue.date, fullDateTime24h),
