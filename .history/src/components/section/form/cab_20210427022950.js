                            ...
                            <Tab eventKey="Réserver" title="Réserver un taxi">
                                <div  style={{
                                    ...
                                    <Form.Row style={{
                                        ...
                                        <Form.Group controlId="description">
                                        <Calendar id="basic" value={formValue.date} onChange={(e) => setFormValue({date: e.value})} />                                        </Form.Group>
                                   
                                        <Form.Group controlId="description">
                                        <Calendar id="time24" value={formValue.hour} onChange={(e) => setFormValue({hour: e.value})} showTime showSeconds />
                                        </Form.Group>
                                    </Form.Row>
                                    <Form.Row style={{
                                        display: "flex",
