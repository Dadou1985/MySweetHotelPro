  ...
  const handleChangePhotoUrl = (event) => {
    ...
    return (
        ...
        <Modal show={listPassword}
            ...
            <Form.Row>
                <Form.Group controlId="description">
                <Form.Control type="text" placeholder="Entrer un nouveau mot de passe" style={{width: "30vw", textAlign: "center"}} value={formValue.password} name="email" onChange={handleChange} />
                </Form.Group>
            </Form.Row>
            </div>
            </Modal.Body>
