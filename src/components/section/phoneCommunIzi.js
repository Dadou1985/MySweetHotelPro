                  ...
                  marginTop: "1vh"
                    ...
                    <AccordionItemButton style={{outline: "none", color: accordionSelected === flow.markup ? "black" : "gray", display: "flex", justifyContent: "space-between"}}>
                      ...
                      <div style={{display: "flex", flexFlow: "column", alignItems: "center", justifyContent: "center"}}>
                        <div style={{fontSize: "1rem", color: accordionSelected === flow.markup ? "black" : "white"}}>{flow.id}</div>
                        <div style={{fontSize: "0.5rem", color: flow.room === "Pre-checkin" ? "red" : "grey"}}>{flow.room !== "Pre-checkin" && t('msh_chat.c_room_maj')} {flow.room}</div>
                      </div>
                        <div style={{display: "flex", alignItems: "center"}}>
                          <Switch
                            checked={flow.status}
