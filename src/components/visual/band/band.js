...
import MshScreen from "./mshVisualBand"
    ...
    return (
        <div style={{
            ...
            {logo ? <div style={{
                ...
                <StaticImage objectFit='contain' src='../../assets/svg/new-logo-msh.png' placeholder="blurred" style={{width: "70%", marginTop: "20%", marginBottom: "20%", filter: "drop-shadow(1px 1px 1px)"}} />
